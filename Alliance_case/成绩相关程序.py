...
def 成绩相关程序():
    ...
    while num <= 250:
        ...
        try:
            dr.driver.find_element_by_xpath(
                '//td[contains(text(), "2480")]').is_displayed()
            dr.driver.find_element_by_xpath(
                '//td[contains(text(), "1750")]').is_displayed()
    ...
    full_score = dr.driver.find_element_by_xpath(
    ...
    dr.driver.switch_to.default_content()
    dr.driver.switch_to.frame("main-frame")
    dr.is_displayed('xpath', '(//a[text()="生成报表"])[9]')
    sleep(2)
    dr.click_('xpath', '(//a[text()="生成报表"])[9]')
    sleep(0.5)
    dr.click_('xpath', '//a[text()="确定"]')
    sleep(0.5)
    dr.click_('xpath', '(//a[text()="生成报表"])[8]')
    sleep(0.5)
    dr.click_('xpath', '//a[text()="确定"]')
    sleep(0.5)
    dr.click_('xpath', '(//a[text()="生成报表"])[7]')
    sleep(0.5)
    dr.click_('xpath', '//a[text()="确定"]')
    sleep(0.5)
    dr.click_('xpath', '(//a[text()="生成报表"])[6]')
    sleep(0.5)
    dr.click_('xpath', '//a[text()="确定"]')
    sleep(0.5)
    dr.click_('xpath', '(//a[text()="生成报表"])[5]')
    sleep(0.5)
    dr.click_('xpath', '//a[text()="确定"]')
    sleep(0.5)
    dr.click_('xpath', '(//a[text()="生成报表"])[4]')
    sleep(0.5)
    ...
    while num <= 20:
        try:
            dr.is_displayed('xpath', '(//a[text()="下载报表"])[1]')
            dr.is_displayed('xpath', '(//a[text()="下载报表"])[2]')
            dr.is_displayed('xpath', '(//a[text()="下载报表"])[3]')
            dr.is_displayed('xpath', '(//a[text()="下载报表"])[4]')
            dr.is_displayed('xpath', '(//a[text()="下载报表"])[5]')
            dr.is_displayed('xpath', '(//a[text()="下载报表"])[6]')
            dr.is_displayed('xpath', '(//a[text()="下载报表"])[7]')
            dr.is_displayed('xpath', '(//a[text()="下载报表"])[8]')
            dr.is_displayed('xpath', '(//a[text()="下载报表"])[9]')
        except Exception as e:
            sleep(5)
            if num == 20:
                print('报表生成错误')
