...
class Browser:
    ...
    def is_displayed(self, method, value):
        ...
        while num <= 20:
            try:
                if method == 'id':
                    result = driver.find_element_by_id(value).is_displayed()
                elif method == 'name':
                    result = driver.find_element_by_name(value).is_displayed()
                elif method == 'xpath':
                    result = driver.find_element_by_xpath(value).is_displayed()
                elif method == 'class':
    ...
    def shot(self):
        ...
        self.driver.get_screenshot_as_file(
            r"D:\PyCharm\Project\yuejuan_\Alliance_case\screenshot/%s.png" % t)
