...
def 任务构建程序():
    ...
    task_name = u'联盟任务' + time.strftime('%Y') + '年' + time.strftime('%m') + '月' + time.strftime('%d') + '日' + time.strftime( ' %H-%M-%S')

    # 登录进入二一阅卷
    dr.open_("http://yjadmin.21cnjy.com")
    sleep(2)
    ...
    dr.click_('xpath', '((//td[text()="一年级(1)班"])[1]/../td)[1]')  # T1
    dr.click_('xpath', '((//td[text()="一年级(2)班"])[1]/../td)[1]')
    dr.click_('xpath', '((//td[text()="一年级(1)班"])[2]/../td)[1]')  # T2
    dr.click_('xpath', '((//td[text()="一年级(2)班"])[2]/../td)[1]')
    dr.click_('xpath', '((//td[text()="一年级(1)班"])[3]/../td)[1]')  # T3
    dr.click_('xpath', '((//td[text()="一年级(2)班"])[3]/../td)[1]')
