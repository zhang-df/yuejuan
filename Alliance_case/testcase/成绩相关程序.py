...
def 成绩相关程序():
    ...
    while num <= 250:
        ...
        try:
            dr.driver.find_element_by_xpath(
                '//td[contains(text(), "1550")]').is_displayed()
            dr.driver.find_element_by_xpath(
                '//td[contains(text(), "1025")]').is_displayed()
    ...
    while num <= 20:
        try:
            ...
            dr.driver.find_element_by_xpath('(//a[text()="下载报表"])[6]').is_displayed()
            dr.driver.find_element_by_xpath('(//a[text()="下载报表"])[7]').is_displayed()
            dr.driver.find_element_by_xpath('(//a[text()="下载报表"])[8]').is_displayed()
            dr.driver.find_element_by_xpath('(//a[text()="下载报表"])[9]').is_displayed()
        except Exception as e:
            sleep(5)
            if num == 20:
                print('报表生成错误')
